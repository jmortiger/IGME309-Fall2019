...
void AppClass::ProcessKeyboard(sf::Event a_event)
{
	...
	else if (sf::Keyboard::isKeyPressed(sf::Keyboard::Num1)) //I am currently pressing the Num1 (not the same as above)
	{
		//std::vector<glm::vec3> lVertex;
		//vertex 1
		lVertex.at(1) = glm::vec3(1.0f - lVertex.at(1).r, 1.0f - lVertex.at(1).g, 1.0f - lVertex.at(1).b); //color
	...
	{
		//vertex 2
		lVertex.at(3) = glm::vec3(1.0f - lVertex.at(3).r, 1.0f - lVertex.at(3).g, 1.0f - lVertex.at(3).b); //color
	...
	{
		//vertex 3
		lVertex.at(5) = glm::vec3(1.0f - lVertex.at(5).r, 1.0f - lVertex.at(5).g, 1.0f - lVertex.at(5).b); //color
